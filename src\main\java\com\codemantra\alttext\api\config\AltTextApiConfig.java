package com.codemantra.alttext.api.config;
...
@Configuration
@MapperScan("com.codemantra.alttext.dao")
public class AltTextApiConfig {
	@Bean
	...
	public SqlSessionFactoryBean sqlSessionFactory() throws Exception {
		...
		sessionFactory.setTypeAliasesPackage("com.codemantra.alttext.model");
